...
<body>
    ...
    <div class="container">
        ...
        <form id="productForm" action="add_product.php" method="POST">
            ...
            <p>
                Edit dbms :
                after the uploaded image has been saved to cloud then the url
                retrieved would be written to mysql db
            </p>
            ...
            <div class="spacebtn">
                ...
                <button type="button" onclick="toInventory()">Back to Inventory</button>
            </div>
        </form>
...
<script type="module">
    ...
    var prod_name = "<?php echo $_SESSION['lastProductId']; ?>";
